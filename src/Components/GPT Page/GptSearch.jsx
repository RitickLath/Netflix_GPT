  ...
  return (
    <div className="w-full bg-[#141414] text-white">
      <div className="w-full text-center">
        <h1 className="text-[#D9232E] relative flex justify-center pt-12 px-4 text-3xl md:text-3xl lg:text-4xl font-bold">
          ...
          <div className="relative">
            ...
            {showdiv && (
              <p className="absolute bottom-7 right-6 w-[300px] rounded-md font-normal bg-white text-left text-xs text-black p-2">
                Share your movie vision and get personalized recommendations.
                Just describe your ideal pick, and our GPT-powered system will
